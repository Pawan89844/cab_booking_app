                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: AppConstants.height*0.02,),
                                Text('+91 1234567890',style: TextStyle(color: Colors.green,fontSize: 15*AppConstants.text),),
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Police Helpline Number',style: TextStyle(color: Colors.black,fontSize: 15*AppConstants.text),),
                                SizedBox(height: AppConstants.height*0.02,),
                                Text('Call us 24 x 7 we will answer you!',style: TextStyle(color: Colors.grey,fontSize: 15*AppConstants.text),),
                                SizedBox(height: AppConstants.height*0.02,),
                                Text('101',style: TextStyle(color: Colors.green,fontSize: 15*AppConstants.text),),
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Ambulance Helpline Number',style: TextStyle(color: Colors.black,fontSize: 15*AppConstants.text),),
                                SizedBox(height: AppConstants.height*0.02,),
                                Text('Call us 24 x 7 we will answer you!',style: TextStyle(color: Colors.grey,fontSize: 15*AppConstants.text),),
                                SizedBox(height: AppConstants.height*0.02,),
                                Text('108',style: TextStyle(color: Colors.green,fontSize: 15*AppConstants.text),),
